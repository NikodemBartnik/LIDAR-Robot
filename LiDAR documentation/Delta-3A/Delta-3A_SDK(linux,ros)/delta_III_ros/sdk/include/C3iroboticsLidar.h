...
namespace everest
{
	namespace hwdrivers
	{
  		...
  		enum TLidarCommandID
    	{
			...
			ADJUST_LASER_POWER_ID=0x07,
			EXIT_ADJUST_LASER_POWER=0x08,
			WRITE_CALIBRATION_DATA=0x07,
			WRITE_FIRMWARE_TO_FLASH=0x0A,
			...
			REPORT_FIXED_POINT_CALIB_DATA=0x18,
			REPORT_FIXED_POINT_MEAS_DATA=0x01A,
			REPORT_DYNAMIC_SCAN_DATA=0x14,
			REPORT_DEVCIE_VERSION=0x19,
	    ...
	    {	
			...
			COMMONDID_ERROR=0x02,
			PARAM_LENGTH_ERROR=0x01,
			PARAM_ERROR=0x03,
			VERIFY_ERROR=0x04,
			TIME_OUT=0x05,
			WRITE_FAIL=0x06,
