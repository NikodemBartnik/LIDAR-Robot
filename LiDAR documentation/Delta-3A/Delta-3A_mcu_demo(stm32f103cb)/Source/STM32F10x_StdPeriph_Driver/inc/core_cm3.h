...
{ 
  ...
  NVIC_SetPriority (SysTick_IRQn, 0);       /* 设置systick优先级为最高 ZHK 20160429*/	
	
  SysTick->VAL   = 0;                                          /* Load the SysTick Counter Value */
  SysTick->CTRL  = SysTick_CTRL_CLKSOURCE_Msk |                /*使用内FCLK Cortex自由运行时钟*/
                   SysTick_CTRL_TICKINT_Msk   |                /*SysTick倒数计数到0时产生SysTick异常请求*/
